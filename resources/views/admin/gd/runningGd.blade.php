        ...
        <div class="col-md-12">
            <div class="panel panel-flat border-top-success">
                <div class="panel-heading">
                    <h6 class="panel-title">All Running General Dairy</h6>
                </div>
                    ...
                    <table class="table table-bordered table-condensed table-hover table-striped datatable">
                        ...
                        @foreach($table as $row)
                            <tr>
                                ...
                                <td>{{$row->email}}</td>
                                <td><a class="btn btn-xs btn-primary p-0" href="{{action('Gd\AdminGdController@complete', ['id' => $row->generaldairyID])}}"  onclick="return confirm('Are you sure to Close this General Dairy ?')" title="End">{{$row->status}}</a></td>
