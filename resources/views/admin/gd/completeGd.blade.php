        ...
        <div class="col-md-12">
            <div class="panel panel-flat border-top-success">
                <div class="panel-heading">
                    <h6 class="panel-title">All Completed General Dairy</h6>
                </div>
                    ...
                    <table class="table table-bordered table-condensed table-hover table-striped datatable">
                        ...
                        @foreach($table as $row)
                            <tr>
                                ...
                                <td><a class="btn btn-xs btn-primary p-0" href="{{action('Gd\AdminGdController@complete_gd', ['id' => $row->generaldairyID])}}"  onclick="return confirm('Are you sure to Close this General Dairy ?')" title="End">{{$row->status}}</a></td>
                                    ...
                                    <ul class="icons-list">
                                        <li class="dropdown">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-right bg-slate">
                                                <li><a class="btn bg-slate-600 no-border-radius pl-10"  href="{{action('Gd\AdminGdController@show_details', ['id' => $row->generaldairyID])}}"  title="Details"style="text-align: left;"><i class="icon-eye"></i> Details</a></li>
