        ...
        <div class="col-md-12">
            <div class="panel panel-flat border-top-success">
                <div class="panel-heading">
                    <h6 class="panel-title">All New  Fir</h6>
                </div>
                    ...
                    <table class="table table-bordered table-condensed table-hover table-striped datatable">
                        ...
                        @foreach($table as $row)
                            <tr>
                                ...
                                <td><a class="btn btn-xs btn-primary p-0" href="{{action('Fir\AdminFirController@running',['id' => $row->firID])}}"  onclick="return confirm('Are you sure to Approved this FIR ?')" title="End">{{$row->status}}</a></td>
