        ...
        <div class="col-md-12">
            <div class="panel panel-flat border-top-success">
                <div class="panel-heading">
                    <h6 class="panel-title">All Completed Missing Goods</h6>
                </div>
                    ...
                    <table class="table table-bordered table-condensed table-hover table-striped datatable">
                        ...
                        @foreach($table as $row)
                            <tr>
                                ...
                                <td><a class="btn btn-xs btn-primary p-0" href=""  title="End">{{$row->status}}</a></td>
                                                        ...
                                                        <div class="panel-body">
                                                            ...
                                                            <div class="col-md-6">
                                                                <ul class="list list-unstyled text-capitalize no-margin-top">
                                                                    ...
                                                                    <li><p class="text-semibold">Completed Date:<span class="text-regular pl-10">{{pub_date($row->completeDate)}}</span></p></li>
                                                                </ul>
                                                            </div>
                                                        </div>
