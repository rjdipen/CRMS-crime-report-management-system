    ...
    <div id="myModal" class="modal fade">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="{{action('History\HistoryController@save')}}" method="post" enctype="multipart/form-data">
                    {{csrf_field()}}
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label class="col-lg-3 control-label">History Image:</label>
                            <div class="col-lg-9">
                                <div class="uploader">
                                    <input class="file-styled required" name="historyImg" type="file">
                                </div>
                            </div>
                        </div><br>
    ...
    <div id="ediModal" class="modal fade">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="{{action('History\HistoryController@edit')}}" method="post" enctype="multipart/form-data">
                    {{csrf_field()}}
